...
r = requests.get("http://localhost:8050/api/reseller/dashboard/summary", headers=headers)
print("SUMMARY STATUS:", r.status_code)
print(r.text)

r = requests.get("http://localhost:8050/api/reseller/dashboard/portfolio-trend", headers=headers)
