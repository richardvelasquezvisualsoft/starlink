...
class EstadoTerminalActual(Dispositivo):
...
class DispositivoGeozonaEstadoActual(Dispositivo):
...
class IpAsignacionActual(Dispositivo):
...
class ControlServicioActual(LineaServicio):
...
class EstadoRouterActual(Router):
