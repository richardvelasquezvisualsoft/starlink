...
from sqlalchemy import BigInteger, Boolean, CHAR, CheckConstraint, Column, Date, DateTime, ForeignKeyConstraint, Index, Integer, Numeric, PrimaryKeyConstraint, SmallInteger, String, Table, Text, UniqueConstraint, text
...
class CatalogoOperacionesRemotas(Base):
...
class IpAsignaciones202603(Base):
    __tablename__ = 'ip_asignaciones_202603'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-03-01'::date AND fecha_hora_lectura < '2026-04-01'::date", name='ck_ip_asignaciones_202603_periodo'),
        PrimaryKeyConstraint('id', name='ip_asignaciones_202603_pkey'),
        UniqueConstraint('dispositivo_id', 'fecha_hora_lectura', name='uq_ip_asignaciones_202603_lectura'),
        Index('brin_ip_asignaciones_202603_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_ip_asignaciones_202603_tenant_disp_fecha', 'tenant_id', 'dispositivo_id', 'fecha_hora_lectura')
    )
    ...
    es_tombstone: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default=text('false'))
...
class IpAsignaciones202604(Base):
    __tablename__ = 'ip_asignaciones_202604'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-04-01'::date AND fecha_hora_lectura < '2026-05-01'::date", name='ck_ip_asignaciones_202604_periodo'),
        PrimaryKeyConstraint('id', name='ip_asignaciones_202604_pkey'),
        UniqueConstraint('dispositivo_id', 'fecha_hora_lectura', name='uq_ip_asignaciones_202604_lectura'),
        Index('brin_ip_asignaciones_202604_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_ip_asignaciones_202604_tenant_disp_fecha', 'tenant_id', 'dispositivo_id', 'fecha_hora_lectura')
    )
...
class IpAsignaciones202605(Base):
    __tablename__ = 'ip_asignaciones_202605'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-05-01'::date AND fecha_hora_lectura < '2026-06-01'::date", name='ck_ip_asignaciones_202605_periodo'),
        PrimaryKeyConstraint('id', name='ip_asignaciones_202605_pkey'),
        UniqueConstraint('dispositivo_id', 'fecha_hora_lectura', name='uq_ip_asignaciones_202605_lectura'),
        Index('brin_ip_asignaciones_202605_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_ip_asignaciones_202605_tenant_disp_fecha', 'tenant_id', 'dispositivo_id', 'fecha_hora_lectura')
    )
...
class IpAsignaciones202606(Base):
    __tablename__ = 'ip_asignaciones_202606'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-06-01'::date AND fecha_hora_lectura < '2026-07-01'::date", name='ck_ip_asignaciones_202606_periodo'),
        PrimaryKeyConstraint('id', name='ip_asignaciones_202606_pkey'),
        UniqueConstraint('dispositivo_id', 'fecha_hora_lectura', name='uq_ip_asignaciones_202606_lectura'),
        Index('brin_ip_asignaciones_202606_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_ip_asignaciones_202606_tenant_disp_fecha', 'tenant_id', 'dispositivo_id', 'fecha_hora_lectura')
    )
...
class IpAsignaciones202607(Base):
    __tablename__ = 'ip_asignaciones_202607'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-07-01'::date AND fecha_hora_lectura < '2026-08-01'::date", name='ck_ip_asignaciones_202607_periodo'),
        PrimaryKeyConstraint('id', name='ip_asignaciones_202607_pkey'),
        UniqueConstraint('dispositivo_id', 'fecha_hora_lectura', name='uq_ip_asignaciones_202607_lectura'),
        Index('brin_ip_asignaciones_202607_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_ip_asignaciones_202607_tenant_disp_fecha', 'tenant_id', 'dispositivo_id', 'fecha_hora_lectura')
    )
...
class IpAsignaciones202608(Base):
    __tablename__ = 'ip_asignaciones_202608'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-08-01'::date AND fecha_hora_lectura < '2026-09-01'::date", name='ck_ip_asignaciones_202608_periodo'),
        PrimaryKeyConstraint('id', name='ip_asignaciones_202608_pkey'),
        UniqueConstraint('dispositivo_id', 'fecha_hora_lectura', name='uq_ip_asignaciones_202608_lectura'),
        Index('brin_ip_asignaciones_202608_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_ip_asignaciones_202608_tenant_disp_fecha', 'tenant_id', 'dispositivo_id', 'fecha_hora_lectura')
    )
...
class IpAsignaciones202609(Base):
    __tablename__ = 'ip_asignaciones_202609'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-09-01'::date AND fecha_hora_lectura < '2026-10-01'::date", name='ck_ip_asignaciones_202609_periodo'),
        PrimaryKeyConstraint('id', name='ip_asignaciones_202609_pkey'),
        UniqueConstraint('dispositivo_id', 'fecha_hora_lectura', name='uq_ip_asignaciones_202609_lectura'),
        Index('brin_ip_asignaciones_202609_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_ip_asignaciones_202609_tenant_disp_fecha', 'tenant_id', 'dispositivo_id', 'fecha_hora_lectura')
    )
...
class IpAsignaciones202610(Base):
    __tablename__ = 'ip_asignaciones_202610'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-10-01'::date AND fecha_hora_lectura < '2026-11-01'::date", name='ck_ip_asignaciones_202610_periodo'),
        PrimaryKeyConstraint('id', name='ip_asignaciones_202610_pkey'),
        UniqueConstraint('dispositivo_id', 'fecha_hora_lectura', name='uq_ip_asignaciones_202610_lectura'),
        Index('brin_ip_asignaciones_202610_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_ip_asignaciones_202610_tenant_disp_fecha', 'tenant_id', 'dispositivo_id', 'fecha_hora_lectura')
    )
...
class TelemetriaRouter202603(Base):
    __tablename__ = 'telemetria_router_202603'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-03-01'::date AND fecha_hora_lectura < '2026-04-01'::date", name='ck_telemetria_router_202603_periodo'),
        PrimaryKeyConstraint('id', name='telemetria_router_202603_pkey'),
        UniqueConstraint('router_id', 'fecha_hora_lectura', name='uq_telemetria_router_202603_lectura'),
        Index('brin_telemetria_router_202603_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_telemetria_router_202603_tenant_linea_fecha', 'tenant_id', 'linea_servicio_id', 'fecha_hora_lectura'),
        Index('ix_telemetria_router_202603_tenant_router_fecha', 'tenant_id', 'router_id', 'fecha_hora_lectura')
    )
    ...
    wifi_uptime_segundos: Mapped[Optional[int]] = mapped_column(BigInteger)
    software_version: Mapped[Optional[str]] = mapped_column(String(200))
    wifi_es_repetidor: Mapped[Optional[bool]] = mapped_column(Boolean)
    wifi_saltos_controlador: Mapped[Optional[int]] = mapped_column(Integer)
    wifi_bypass: Mapped[Optional[bool]] = mapped_column(Boolean)
    ...
    pop_drop_rate: Mapped[Optional[decimal.Decimal]] = mapped_column(Numeric(8, 6))
    pop_latency_ms: Mapped[Optional[decimal.Decimal]] = mapped_column(Numeric(12, 4))
    dish_drop_rate: Mapped[Optional[decimal.Decimal]] = mapped_column(Numeric(8, 6))
    ...
    rx_rate_2ghz_mbps: Mapped[Optional[decimal.Decimal]] = mapped_column(Numeric(12, 4))
    tx_rate_2ghz_mbps: Mapped[Optional[decimal.Decimal]] = mapped_column(Numeric(12, 4))
    signal_2ghz_min: Mapped[Optional[decimal.Decimal]] = mapped_column(Numeric(12, 4))
    signal_2ghz_max: Mapped[Optional[decimal.Decimal]] = mapped_column(Numeric(12, 4))
    signal_2ghz_avg: Mapped[Optional[decimal.Decimal]] = mapped_column(Numeric(12, 4))
    rx_rate_5ghz_mbps: Mapped[Optional[decimal.Decimal]] = mapped_column(Numeric(12, 4))
    tx_rate_5ghz_mbps: Mapped[Optional[decimal.Decimal]] = mapped_column(Numeric(12, 4))
    signal_5ghz_min: Mapped[Optional[decimal.Decimal]] = mapped_column(Numeric(12, 4))
    signal_5ghz_max: Mapped[Optional[decimal.Decimal]] = mapped_column(Numeric(12, 4))
    signal_5ghz_avg: Mapped[Optional[decimal.Decimal]] = mapped_column(Numeric(12, 4))
    raw_json: Mapped[Optional[dict]] = mapped_column(JSONB)


class TelemetriaRouter202604(Base):
    __tablename__ = 'telemetria_router_202604'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-04-01'::date AND fecha_hora_lectura < '2026-05-01'::date", name='ck_telemetria_router_202604_periodo'),
        PrimaryKeyConstraint('id', name='telemetria_router_202604_pkey'),
        UniqueConstraint('router_id', 'fecha_hora_lectura', name='uq_telemetria_router_202604_lectura'),
        Index('brin_telemetria_router_202604_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_telemetria_router_202604_tenant_linea_fecha', 'tenant_id', 'linea_servicio_id', 'fecha_hora_lectura'),
        Index('ix_telemetria_router_202604_tenant_router_fecha', 'tenant_id', 'router_id', 'fecha_hora_lectura')
    )
...
class TelemetriaRouter202605(Base):
    __tablename__ = 'telemetria_router_202605'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-05-01'::date AND fecha_hora_lectura < '2026-06-01'::date", name='ck_telemetria_router_202605_periodo'),
        PrimaryKeyConstraint('id', name='telemetria_router_202605_pkey'),
        UniqueConstraint('router_id', 'fecha_hora_lectura', name='uq_telemetria_router_202605_lectura'),
        Index('brin_telemetria_router_202605_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_telemetria_router_202605_tenant_linea_fecha', 'tenant_id', 'linea_servicio_id', 'fecha_hora_lectura'),
        Index('ix_telemetria_router_202605_tenant_router_fecha', 'tenant_id', 'router_id', 'fecha_hora_lectura')
    )
...
class TelemetriaRouter202606(Base):
    __tablename__ = 'telemetria_router_202606'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-06-01'::date AND fecha_hora_lectura < '2026-07-01'::date", name='ck_telemetria_router_202606_periodo'),
        PrimaryKeyConstraint('id', name='telemetria_router_202606_pkey'),
        UniqueConstraint('router_id', 'fecha_hora_lectura', name='uq_telemetria_router_202606_lectura'),
        Index('brin_telemetria_router_202606_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_telemetria_router_202606_tenant_linea_fecha', 'tenant_id', 'linea_servicio_id', 'fecha_hora_lectura'),
        Index('ix_telemetria_router_202606_tenant_router_fecha', 'tenant_id', 'router_id', 'fecha_hora_lectura')
    )
...
class TelemetriaRouter202607(Base):
    __tablename__ = 'telemetria_router_202607'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-07-01'::date AND fecha_hora_lectura < '2026-08-01'::date", name='ck_telemetria_router_202607_periodo'),
        PrimaryKeyConstraint('id', name='telemetria_router_202607_pkey'),
        UniqueConstraint('router_id', 'fecha_hora_lectura', name='uq_telemetria_router_202607_lectura'),
        Index('brin_telemetria_router_202607_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_telemetria_router_202607_tenant_linea_fecha', 'tenant_id', 'linea_servicio_id', 'fecha_hora_lectura'),
        Index('ix_telemetria_router_202607_tenant_router_fecha', 'tenant_id', 'router_id', 'fecha_hora_lectura')
    )
...
class TelemetriaRouter202608(Base):
    __tablename__ = 'telemetria_router_202608'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-08-01'::date AND fecha_hora_lectura < '2026-09-01'::date", name='ck_telemetria_router_202608_periodo'),
        PrimaryKeyConstraint('id', name='telemetria_router_202608_pkey'),
        UniqueConstraint('router_id', 'fecha_hora_lectura', name='uq_telemetria_router_202608_lectura'),
        Index('brin_telemetria_router_202608_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_telemetria_router_202608_tenant_linea_fecha', 'tenant_id', 'linea_servicio_id', 'fecha_hora_lectura'),
        Index('ix_telemetria_router_202608_tenant_router_fecha', 'tenant_id', 'router_id', 'fecha_hora_lectura')
    )
...
class TelemetriaRouter202609(Base):
    __tablename__ = 'telemetria_router_202609'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-09-01'::date AND fecha_hora_lectura < '2026-10-01'::date", name='ck_telemetria_router_202609_periodo'),
        PrimaryKeyConstraint('id', name='telemetria_router_202609_pkey'),
        UniqueConstraint('router_id', 'fecha_hora_lectura', name='uq_telemetria_router_202609_lectura'),
        Index('brin_telemetria_router_202609_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_telemetria_router_202609_tenant_linea_fecha', 'tenant_id', 'linea_servicio_id', 'fecha_hora_lectura'),
        Index('ix_telemetria_router_202609_tenant_router_fecha', 'tenant_id', 'router_id', 'fecha_hora_lectura')
    )
...
class TelemetriaRouter202610(Base):
    __tablename__ = 'telemetria_router_202610'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-10-01'::date AND fecha_hora_lectura < '2026-11-01'::date", name='ck_telemetria_router_202610_periodo'),
        PrimaryKeyConstraint('id', name='telemetria_router_202610_pkey'),
        UniqueConstraint('router_id', 'fecha_hora_lectura', name='uq_telemetria_router_202610_lectura'),
        Index('brin_telemetria_router_202610_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_telemetria_router_202610_tenant_linea_fecha', 'tenant_id', 'linea_servicio_id', 'fecha_hora_lectura'),
        Index('ix_telemetria_router_202610_tenant_router_fecha', 'tenant_id', 'router_id', 'fecha_hora_lectura')
    )
...
class TelemetriaTerminal202603(Base):
    __tablename__ = 'telemetria_terminal_202603'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-03-01'::date AND fecha_hora_lectura < '2026-04-01'::date", name='ck_telemetria_terminal_202603_periodo'),
        PrimaryKeyConstraint('id', name='telemetria_terminal_202603_pkey'),
        UniqueConstraint('dispositivo_id', 'fecha_hora_lectura', name='uq_telemetria_terminal_202603_lectura'),
        Index('brin_telemetria_terminal_202603_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_telemetria_terminal_202603_tenant_disp_fecha', 'tenant_id', 'dispositivo_id', 'fecha_hora_lectura'),
        Index('ix_telemetria_terminal_202603_tenant_linea_fecha', 'tenant_id', 'linea_servicio_id', 'fecha_hora_lectura')
    )
    ...
    software_version: Mapped[Optional[str]] = mapped_column(String(200))
    segundos_hasta_reboot_update: Mapped[Optional[int]] = mapped_column(Integer)
    raw_json: Mapped[Optional[dict]] = mapped_column(JSONB)


class TelemetriaTerminal202604(Base):
    __tablename__ = 'telemetria_terminal_202604'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-04-01'::date AND fecha_hora_lectura < '2026-05-01'::date", name='ck_telemetria_terminal_202604_periodo'),
        PrimaryKeyConstraint('id', name='telemetria_terminal_202604_pkey'),
        UniqueConstraint('dispositivo_id', 'fecha_hora_lectura', name='uq_telemetria_terminal_202604_lectura'),
        Index('brin_telemetria_terminal_202604_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_telemetria_terminal_202604_tenant_disp_fecha', 'tenant_id', 'dispositivo_id', 'fecha_hora_lectura'),
        Index('ix_telemetria_terminal_202604_tenant_linea_fecha', 'tenant_id', 'linea_servicio_id', 'fecha_hora_lectura')
    )
...
class TelemetriaTerminal202605(Base):
    __tablename__ = 'telemetria_terminal_202605'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-05-01'::date AND fecha_hora_lectura < '2026-06-01'::date", name='ck_telemetria_terminal_202605_periodo'),
        PrimaryKeyConstraint('id', name='telemetria_terminal_202605_pkey'),
        UniqueConstraint('dispositivo_id', 'fecha_hora_lectura', name='uq_telemetria_terminal_202605_lectura'),
        Index('brin_telemetria_terminal_202605_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_telemetria_terminal_202605_tenant_disp_fecha', 'tenant_id', 'dispositivo_id', 'fecha_hora_lectura'),
        Index('ix_telemetria_terminal_202605_tenant_linea_fecha', 'tenant_id', 'linea_servicio_id', 'fecha_hora_lectura')
    )
...
class TelemetriaTerminal202606(Base):
    __tablename__ = 'telemetria_terminal_202606'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-06-01'::date AND fecha_hora_lectura < '2026-07-01'::date", name='ck_telemetria_terminal_202606_periodo'),
        PrimaryKeyConstraint('id', name='telemetria_terminal_202606_pkey'),
        UniqueConstraint('dispositivo_id', 'fecha_hora_lectura', name='uq_telemetria_terminal_202606_lectura'),
        Index('brin_telemetria_terminal_202606_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_telemetria_terminal_202606_tenant_disp_fecha', 'tenant_id', 'dispositivo_id', 'fecha_hora_lectura'),
        Index('ix_telemetria_terminal_202606_tenant_linea_fecha', 'tenant_id', 'linea_servicio_id', 'fecha_hora_lectura')
    )
...
class TelemetriaTerminal202607(Base):
    __tablename__ = 'telemetria_terminal_202607'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-07-01'::date AND fecha_hora_lectura < '2026-08-01'::date", name='ck_telemetria_terminal_202607_periodo'),
        PrimaryKeyConstraint('id', name='telemetria_terminal_202607_pkey'),
        UniqueConstraint('dispositivo_id', 'fecha_hora_lectura', name='uq_telemetria_terminal_202607_lectura'),
        Index('brin_telemetria_terminal_202607_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_telemetria_terminal_202607_tenant_disp_fecha', 'tenant_id', 'dispositivo_id', 'fecha_hora_lectura'),
        Index('ix_telemetria_terminal_202607_tenant_linea_fecha', 'tenant_id', 'linea_servicio_id', 'fecha_hora_lectura')
    )
...
class TelemetriaTerminal202608(Base):
    __tablename__ = 'telemetria_terminal_202608'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-08-01'::date AND fecha_hora_lectura < '2026-09-01'::date", name='ck_telemetria_terminal_202608_periodo'),
        PrimaryKeyConstraint('id', name='telemetria_terminal_202608_pkey'),
        UniqueConstraint('dispositivo_id', 'fecha_hora_lectura', name='uq_telemetria_terminal_202608_lectura'),
        Index('brin_telemetria_terminal_202608_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_telemetria_terminal_202608_tenant_disp_fecha', 'tenant_id', 'dispositivo_id', 'fecha_hora_lectura'),
        Index('ix_telemetria_terminal_202608_tenant_linea_fecha', 'tenant_id', 'linea_servicio_id', 'fecha_hora_lectura')
    )
...
class TelemetriaTerminal202609(Base):
    __tablename__ = 'telemetria_terminal_202609'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-09-01'::date AND fecha_hora_lectura < '2026-10-01'::date", name='ck_telemetria_terminal_202609_periodo'),
        PrimaryKeyConstraint('id', name='telemetria_terminal_202609_pkey'),
        UniqueConstraint('dispositivo_id', 'fecha_hora_lectura', name='uq_telemetria_terminal_202609_lectura'),
        Index('brin_telemetria_terminal_202609_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_telemetria_terminal_202609_tenant_disp_fecha', 'tenant_id', 'dispositivo_id', 'fecha_hora_lectura'),
        Index('ix_telemetria_terminal_202609_tenant_linea_fecha', 'tenant_id', 'linea_servicio_id', 'fecha_hora_lectura')
    )
...
class TelemetriaTerminal202610(Base):
    __tablename__ = 'telemetria_terminal_202610'
    __table_args__ = (
        CheckConstraint("fecha_hora_lectura >= '2026-10-01'::date AND fecha_hora_lectura < '2026-11-01'::date", name='ck_telemetria_terminal_202610_periodo'),
        PrimaryKeyConstraint('id', name='telemetria_terminal_202610_pkey'),
        UniqueConstraint('dispositivo_id', 'fecha_hora_lectura', name='uq_telemetria_terminal_202610_lectura'),
        Index('brin_telemetria_terminal_202610_fecha', 'fecha_hora_lectura', postgresql_using='brin'),
        Index('ix_telemetria_terminal_202610_tenant_disp_fecha', 'tenant_id', 'dispositivo_id', 'fecha_hora_lectura'),
        Index('ix_telemetria_terminal_202610_tenant_linea_fecha', 'tenant_id', 'linea_servicio_id', 'fecha_hora_lectura')
    )
...
class Usuarios(Base):
    ...
    catalogo_alertas_creado_por: Mapped[list['CatalogoAlertas']] = relationship('CatalogoAlertas', foreign_keys='[CatalogoAlertas.creado_por]', back_populates='usuarios')
    catalogo_alertas_modificado_por: Mapped[list['CatalogoAlertas']] = relationship('CatalogoAlertas', foreign_keys='[CatalogoAlertas.modificado_por]', back_populates='usuarios_')
    dispositivos_creado_por: Mapped[list['Dispositivos']] = relationship('Dispositivos', foreign_keys='[Dispositivos.creado_por]', back_populates='usuarios')
    dispositivos_modificado_por: Mapped[list['Dispositivos']] = relationship('Dispositivos', foreign_keys='[Dispositivos.modificado_por]', back_populates='usuarios_')
    tenants_creado_por: Mapped[list['Tenants']] = relationship('Tenants', foreign_keys='[Tenants.creado_por]', back_populates='usuarios')
    tenants_modificado_por: Mapped[list['Tenants']] = relationship('Tenants', foreign_keys='[Tenants.modificado_por]', back_populates='usuarios_')
    alertas_log: Mapped[list['AlertasLog']] = relationship('AlertasLog', back_populates='usuarios')
    centros_costos_creado_por: Mapped[list['CentrosCostos']] = relationship('CentrosCostos', foreign_keys='[CentrosCostos.creado_por]', back_populates='usuarios')
    centros_costos_modificado_por: Mapped[list['CentrosCostos']] = relationship('CentrosCostos', foreign_keys='[CentrosCostos.modificado_por]', back_populates='usuarios_')
    colaboradores_creado_por: Mapped[list['Colaboradores']] = relationship('Colaboradores', foreign_keys='[Colaboradores.creado_por]', back_populates='usuarios')
    colaboradores_modificado_por: Mapped[list['Colaboradores']] = relationship('Colaboradores', foreign_keys='[Colaboradores.modificado_por]', back_populates='usuarios_')
    comprobantes_cliente_modificado_por: Mapped[list['ComprobantesCliente']] = relationship('ComprobantesCliente', foreign_keys='[ComprobantesCliente.modificado_por]', back_populates='usuarios')
    comprobantes_cliente_registrado_por: Mapped[list['ComprobantesCliente']] = relationship('ComprobantesCliente', foreign_keys='[ComprobantesCliente.registrado_por]', back_populates='usuarios_')
    cuentas_creado_por: Mapped[list['Cuentas']] = relationship('Cuentas', foreign_keys='[Cuentas.creado_por]', back_populates='usuarios')
    cuentas_modificado_por: Mapped[list['Cuentas']] = relationship('Cuentas', foreign_keys='[Cuentas.modificado_por]', back_populates='usuarios_')
    geozona_politicas_creado_por: Mapped[list['GeozonaPoliticas']] = relationship('GeozonaPoliticas', foreign_keys='[GeozonaPoliticas.creado_por]', back_populates='usuarios')
    geozona_politicas_modificado_por: Mapped[list['GeozonaPoliticas']] = relationship('GeozonaPoliticas', foreign_keys='[GeozonaPoliticas.modificado_por]', back_populates='usuarios_')
    geozonas_creado_por: Mapped[list['Geozonas']] = relationship('Geozonas', foreign_keys='[Geozonas.creado_por]', back_populates='usuarios')
    geozonas_modificado_por: Mapped[list['Geozonas']] = relationship('Geozonas', foreign_keys='[Geozonas.modificado_por]', back_populates='usuarios_')
    niveles_organizacion_config_creado_por: Mapped[list['NivelesOrganizacionConfig']] = relationship('NivelesOrganizacionConfig', foreign_keys='[NivelesOrganizacionConfig.creado_por]', back_populates='usuarios')
    niveles_organizacion_config_modificado_por: Mapped[list['NivelesOrganizacionConfig']] = relationship('NivelesOrganizacionConfig', foreign_keys='[NivelesOrganizacionConfig.modificado_por]', back_populates='usuarios_')
    tenant_usuarios: Mapped[list['TenantUsuarios']] = relationship('TenantUsuarios', back_populates='usuario')
    unidades_organizacionales_creado_por: Mapped[list['UnidadesOrganizacionales']] = relationship('UnidadesOrganizacionales', foreign_keys='[UnidadesOrganizacionales.creado_por]', back_populates='usuarios')
    unidades_organizacionales_modificado_por: Mapped[list['UnidadesOrganizacionales']] = relationship('UnidadesOrganizacionales', foreign_keys='[UnidadesOrganizacionales.modificado_por]', back_populates='usuarios_')
    ...
    lineas_servicio_creado_por: Mapped[list['LineasServicio']] = relationship('LineasServicio', foreign_keys='[LineasServicio.creado_por]', back_populates='usuarios')
    lineas_servicio_modificado_por: Mapped[list['LineasServicio']] = relationship('LineasServicio', foreign_keys='[LineasServicio.modificado_por]', back_populates='usuarios_')
    routers_creado_por: Mapped[list['Routers']] = relationship('Routers', foreign_keys='[Routers.creado_por]', back_populates='usuarios')
    routers_modificado_por: Mapped[list['Routers']] = relationship('Routers', foreign_keys='[Routers.modificado_por]', back_populates='usuarios_')
    ...
    comandos_remotos_log: Mapped[list['ComandosRemotosLog']] = relationship('ComandosRemotosLog', back_populates='usuarios')
    control_servicio_actual: Mapped[list['ControlServicioActual']] = relationship('ControlServicioActual', back_populates='usuarios')
    politicas_servicio_creado_por: Mapped[list['PoliticasServicio']] = relationship('PoliticasServicio', foreign_keys='[PoliticasServicio.creado_por]', back_populates='usuarios')
    politicas_servicio_modificado_por: Mapped[list['PoliticasServicio']] = relationship('PoliticasServicio', foreign_keys='[PoliticasServicio.modificado_por]', back_populates='usuarios_')
    ...
    geozona_eventos: Mapped[list['GeozonaEventos']] = relationship('GeozonaEventos', back_populates='usuarios')
...
class CatalogoAlertas(Base):
    ...
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[creado_por], back_populates='catalogo_alertas_creado_por')
    usuarios_: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[modificado_por], back_populates='catalogo_alertas_modificado_por')
    alertas_log: Mapped[list['AlertasLog']] = relationship('AlertasLog', back_populates='catalogo_alerta')
...
class Dispositivos(Base):
    ...
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[creado_por], back_populates='dispositivos_creado_por')
    usuarios_: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[modificado_por], back_populates='dispositivos_modificado_por')
    alertas_log: Mapped[list['AlertasLog']] = relationship('AlertasLog', back_populates='dispositivo')
    ...
    lineas_servicio: Mapped[list['LineasServicio']] = relationship('LineasServicio', back_populates='dispositivo')
    routers: Mapped[list['Routers']] = relationship('Routers', back_populates='dispositivo')
    ...
    geozona_eventos: Mapped[list['GeozonaEventos']] = relationship('GeozonaEventos', back_populates='dispositivo')
...
class Tenants(Base):
    ...
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[creado_por], back_populates='tenants_creado_por')
    usuarios_: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[modificado_por], back_populates='tenants_modificado_por')
    centros_costos: Mapped[list['CentrosCostos']] = relationship('CentrosCostos', back_populates='tenant')
    colaboradores: Mapped[list['Colaboradores']] = relationship('Colaboradores', back_populates='tenant')
    comprobantes_cliente: Mapped[list['ComprobantesCliente']] = relationship('ComprobantesCliente', back_populates='tenant')
    cuentas: Mapped[list['Cuentas']] = relationship('Cuentas', back_populates='tenant')
    geozona_politicas: Mapped[list['GeozonaPoliticas']] = relationship('GeozonaPoliticas', back_populates='tenant')
    geozonas: Mapped[list['Geozonas']] = relationship('Geozonas', back_populates='tenant')
    niveles_organizacion_config: Mapped[list['NivelesOrganizacionConfig']] = relationship('NivelesOrganizacionConfig', back_populates='tenant')
    sincronizaciones_api: Mapped[list['SincronizacionesApi']] = relationship('SincronizacionesApi', back_populates='tenant')
    tenant_usuarios: Mapped[list['TenantUsuarios']] = relationship('TenantUsuarios', back_populates='tenant')
    unidades_organizacionales: Mapped[list['UnidadesOrganizacionales']] = relationship('UnidadesOrganizacionales', back_populates='tenant')
    ...
    politicas_servicio: Mapped[list['PoliticasServicio']] = relationship('PoliticasServicio', back_populates='tenant')
    ...
    geozona_eventos: Mapped[list['GeozonaEventos']] = relationship('GeozonaEventos', back_populates='tenant')


class AlertasLog(Base):
    ...
    catalogo_alerta: Mapped['CatalogoAlertas'] = relationship('CatalogoAlertas', back_populates='alertas_log')
    dispositivo: Mapped['Dispositivos'] = relationship('Dispositivos', back_populates='alertas_log')
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', back_populates='alertas_log')
...
class CentrosCostos(Base):
    ...
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[creado_por], back_populates='centros_costos_creado_por')
    usuarios_: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[modificado_por], back_populates='centros_costos_modificado_por')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='centros_costos')
...
class Colaboradores(Base):
    ...
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[creado_por], back_populates='colaboradores_creado_por')
    usuarios_: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[modificado_por], back_populates='colaboradores_modificado_por')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='colaboradores')
    ...
    geozona_eventos: Mapped[list['GeozonaEventos']] = relationship('GeozonaEventos', back_populates='colaborador')


class ComprobantesCliente(Base):
    ...
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[modificado_por], back_populates='comprobantes_cliente_modificado_por')
    usuarios_: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[registrado_por], back_populates='comprobantes_cliente_registrado_por')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='comprobantes_cliente')
    comprobante_cliente_lineas: Mapped[list['ComprobanteClienteLineas']] = relationship('ComprobanteClienteLineas', back_populates='comprobante')
...
class Cuentas(Base):
    ...
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[creado_por], back_populates='cuentas_creado_por')
    usuarios_: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[modificado_por], back_populates='cuentas_modificado_por')
    tenant: Mapped[Optional['Tenants']] = relationship('Tenants', back_populates='cuentas')
    ip_asignacion_actual: Mapped[list['IpAsignacionActual']] = relationship('IpAsignacionActual', back_populates='cuenta')
    lineas_servicio: Mapped[list['LineasServicio']] = relationship('LineasServicio', back_populates='cuenta')
    routers: Mapped[list['Routers']] = relationship('Routers', back_populates='cuenta')
    ...
    starlink_facturas_reseller: Mapped[list['StarlinkFacturasReseller']] = relationship('StarlinkFacturasReseller', back_populates='cuenta')
...
class EstadoServicioLog(Base):
    ...
    dispositivo: Mapped['Dispositivos'] = relationship('Dispositivos', back_populates='estado_servicio_log')


class EstadoTerminalActual(Dispositivos):
...
class GeolocalizacionLog(Base):
    ...
    dispositivo: Mapped['Dispositivos'] = relationship('Dispositivos', back_populates='geolocalizacion_log')


class GeozonaPoliticas(Base):
    ...
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[creado_por], back_populates='geozona_politicas_creado_por')
    usuarios_: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[modificado_por], back_populates='geozona_politicas_modificado_por')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='geozona_politicas')
    ...
    geozona_eventos: Mapped[list['GeozonaEventos']] = relationship('GeozonaEventos', back_populates='politica')
...
class Geozonas(Base):
    ...
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[creado_por], back_populates='geozonas_creado_por')
    usuarios_: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[modificado_por], back_populates='geozonas_modificado_por')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='geozonas')
    ...
    geozona_h3_celdas: Mapped[list['GeozonaH3Celdas']] = relationship('GeozonaH3Celdas', back_populates='geozona')
    geozona_eventos: Mapped[list['GeozonaEventos']] = relationship('GeozonaEventos', back_populates='geozona')


class NivelesOrganizacionConfig(Base):
    ...
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[creado_por], back_populates='niveles_organizacion_config_creado_por')
    usuarios_: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[modificado_por], back_populates='niveles_organizacion_config_modificado_por')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='niveles_organizacion_config')
...
class SincronizacionesApi(Base):
    ...
    tenant: Mapped[Optional['Tenants']] = relationship('Tenants', back_populates='sincronizaciones_api')
...
class TelemetriaLog(Base):
    ...
    dispositivo: Mapped['Dispositivos'] = relationship('Dispositivos', back_populates='telemetria_log')


class TenantUsuarios(Base):
    ...
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='tenant_usuarios')
    usuario: Mapped['Usuarios'] = relationship('Usuarios', back_populates='tenant_usuarios')


class UnidadesOrganizacionales(Base):
    ...
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[creado_por], back_populates='unidades_organizacionales_creado_por')
    usuarios_: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[modificado_por], back_populates='unidades_organizacionales_modificado_por')
    parent: Mapped[Optional['UnidadesOrganizacionales']] = relationship('UnidadesOrganizacionales', remote_side=[id], back_populates='parent_reverse')
    parent_reverse: Mapped[list['UnidadesOrganizacionales']] = relationship('UnidadesOrganizacionales', remote_side=[parent_id], back_populates='parent')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='unidades_organizacionales')
...
class ColaboradorDispositivoHistorial(Base):
    ...
    colaborador: Mapped['Colaboradores'] = relationship('Colaboradores', back_populates='colaborador_dispositivo_historial')
    dispositivo: Mapped['Dispositivos'] = relationship('Dispositivos', back_populates='colaborador_dispositivo_historial')
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', back_populates='colaborador_dispositivo_historial')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='colaborador_dispositivo_historial')
...
class ColaboradorUnidadHistorial(Base):
    ...
    colaborador: Mapped['Colaboradores'] = relationship('Colaboradores', back_populates='colaborador_unidad_historial')
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', back_populates='colaborador_unidad_historial')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='colaborador_unidad_historial')
    unidad_nivel3: Mapped['UnidadesOrganizacionales'] = relationship('UnidadesOrganizacionales', back_populates='colaborador_unidad_historial')


class DispositivoGeozonaEstadoActual(Dispositivos):
    ...
    geozona: Mapped['Geozonas'] = relationship('Geozonas', back_populates='dispositivo_geozona_estado_actual')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='dispositivo_geozona_estado_actual')
...
class DispositivoGeozonaHistorial(Base):
    ...
    dispositivo: Mapped['Dispositivos'] = relationship('Dispositivos', back_populates='dispositivo_geozona_historial')
    geozona: Mapped['Geozonas'] = relationship('Geozonas', back_populates='dispositivo_geozona_historial')
    politica: Mapped['GeozonaPoliticas'] = relationship('GeozonaPoliticas', back_populates='dispositivo_geozona_historial')
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', back_populates='dispositivo_geozona_historial')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='dispositivo_geozona_historial')


class GeozonaH3Celdas(Base):
    ...
    geozona: Mapped['Geozonas'] = relationship('Geozonas', back_populates='geozona_h3_celdas')


class IpAsignacionActual(Dispositivos):
    ...
    cuenta: Mapped[Optional['Cuentas']] = relationship('Cuentas', back_populates='ip_asignacion_actual')


class LineasServicio(Base):
    ...
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[creado_por], back_populates='lineas_servicio_creado_por')
    cuenta: Mapped[Optional['Cuentas']] = relationship('Cuentas', back_populates='lineas_servicio')
    dispositivo: Mapped[Optional['Dispositivos']] = relationship('Dispositivos', back_populates='lineas_servicio')
    usuarios_: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[modificado_por], back_populates='lineas_servicio_modificado_por')
    comandos_remotos_log: Mapped[list['ComandosRemotosLog']] = relationship('ComandosRemotosLog', back_populates='linea_servicio')
    comprobante_cliente_lineas: Mapped[list['ComprobanteClienteLineas']] = relationship('ComprobanteClienteLineas', back_populates='linea_servicio')
    consumo_ciclos: Mapped[list['ConsumoCiclos']] = relationship('ConsumoCiclos', back_populates='linea_servicio')
    ...
    direcciones_servicio: Mapped[list['DireccionesServicio']] = relationship('DireccionesServicio', back_populates='linea_servicio')
    ...
    politicas_servicio: Mapped[list['PoliticasServicio']] = relationship('PoliticasServicio', back_populates='linea_servicio')
    ...
    geozona_eventos: Mapped[list['GeozonaEventos']] = relationship('GeozonaEventos', back_populates='linea_servicio')
    starlink_factura_lineas: Mapped[list['StarlinkFacturaLineas']] = relationship('StarlinkFacturaLineas', back_populates='linea_servicio')
...
class Routers(Base):
    ...
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[creado_por], back_populates='routers_creado_por')
    cuenta: Mapped[Optional['Cuentas']] = relationship('Cuentas', back_populates='routers')
    dispositivo: Mapped[Optional['Dispositivos']] = relationship('Dispositivos', back_populates='routers')
    usuarios_: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[modificado_por], back_populates='routers_modificado_por')
    comandos_remotos_log: Mapped[list['ComandosRemotosLog']] = relationship('ComandosRemotosLog', back_populates='router')
...
class StarlinkBalanceHistorial(Base):
    ...
    cuenta: Mapped['Cuentas'] = relationship('Cuentas', back_populates='starlink_balance_historial')


class StarlinkFacturasReseller(Base):
    ...
    cuenta: Mapped['Cuentas'] = relationship('Cuentas', back_populates='starlink_facturas_reseller')
    starlink_factura_detalles: Mapped[list['StarlinkFacturaDetalles']] = relationship('StarlinkFacturaDetalles', back_populates='factura')
...
class UnidadCentroCostoHistorial(Base):
    ...
    centro_costo: Mapped['CentrosCostos'] = relationship('CentrosCostos', back_populates='unidad_centro_costo_historial')
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', back_populates='unidad_centro_costo_historial')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='unidad_centro_costo_historial')
    unidad: Mapped['UnidadesOrganizacionales'] = relationship('UnidadesOrganizacionales', back_populates='unidad_centro_costo_historial')


class ComandosRemotosLog(Base):
    ...
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', back_populates='comandos_remotos_log')
    linea_servicio: Mapped[Optional['LineasServicio']] = relationship('LineasServicio', back_populates='comandos_remotos_log')
    router: Mapped[Optional['Routers']] = relationship('Routers', back_populates='comandos_remotos_log')
    ...
    geozona_eventos: Mapped[list['GeozonaEventos']] = relationship('GeozonaEventos', back_populates='comando_remoto')


class ComprobanteClienteLineas(Base):
    ...
    comprobante: Mapped['ComprobantesCliente'] = relationship('ComprobantesCliente', back_populates='comprobante_cliente_lineas')
    linea_servicio: Mapped['LineasServicio'] = relationship('LineasServicio', back_populates='comprobante_cliente_lineas')


class ConsumoCiclos(Base):
    ...
    linea_servicio: Mapped['LineasServicio'] = relationship('LineasServicio', back_populates='consumo_ciclos')
...
class ConsumoDiario(Base):
    ...
    linea_servicio: Mapped['LineasServicio'] = relationship('LineasServicio', back_populates='consumo_diario')


class ControlServicioActual(LineasServicio):
    ...
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', back_populates='control_servicio_actual')
...
class CostoServicioMes(Base):
    ...
    centro_costo: Mapped[Optional['CentrosCostos']] = relationship('CentrosCostos', back_populates='costo_servicio_mes')
    colaborador: Mapped[Optional['Colaboradores']] = relationship('Colaboradores', back_populates='costo_servicio_mes')
    dispositivo: Mapped[Optional['Dispositivos']] = relationship('Dispositivos', back_populates='costo_servicio_mes')
    linea_servicio: Mapped['LineasServicio'] = relationship('LineasServicio', back_populates='costo_servicio_mes')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='costo_servicio_mes')
    unidad_nivel1: Mapped[Optional['UnidadesOrganizacionales']] = relationship('UnidadesOrganizacionales', foreign_keys=[unidad_nivel1_id], back_populates='costo_servicio_mes_unidad_nivel1')
    unidad_nivel2: Mapped[Optional['UnidadesOrganizacionales']] = relationship('UnidadesOrganizacionales', foreign_keys=[unidad_nivel2_id], back_populates='costo_servicio_mes_unidad_nivel2')
    unidad_nivel3: Mapped[Optional['UnidadesOrganizacionales']] = relationship('UnidadesOrganizacionales', foreign_keys=[unidad_nivel3_id], back_populates='costo_servicio_mes_unidad_nivel3')


class DireccionesServicio(Base):
    ...
    linea_servicio: Mapped['LineasServicio'] = relationship('LineasServicio', back_populates='direcciones_servicio')


class EstadoRouterActual(Routers):
...
class LineaDispositivoHistorial(Base):
    ...
    dispositivo: Mapped['Dispositivos'] = relationship('Dispositivos', back_populates='linea_dispositivo_historial')
    linea_servicio: Mapped['LineasServicio'] = relationship('LineasServicio', back_populates='linea_dispositivo_historial')
...
class LineaPlanHistorial(Base):
    ...
    linea_servicio: Mapped['LineasServicio'] = relationship('LineasServicio', back_populates='linea_plan_historial')


class PoliticasServicio(Base):
    ...
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[creado_por], back_populates='politicas_servicio_creado_por')
    linea_servicio: Mapped[Optional['LineasServicio']] = relationship('LineasServicio', back_populates='politicas_servicio')
    usuarios_: Mapped[Optional['Usuarios']] = relationship('Usuarios', foreign_keys=[modificado_por], back_populates='politicas_servicio_modificado_por')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='politicas_servicio')
...
class SaldosHistorial(Base):
    ...
    linea_servicio: Mapped['LineasServicio'] = relationship('LineasServicio', back_populates='saldos_historial')
...
class ServicioResumenDia(Base):
    ...
    linea_servicio: Mapped['LineasServicio'] = relationship('LineasServicio', back_populates='servicio_resumen_dia')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='servicio_resumen_dia')


class StarlinkFacturaDetalles(Base):
    ...
    factura: Mapped['StarlinkFacturasReseller'] = relationship('StarlinkFacturasReseller', back_populates='starlink_factura_detalles')
    starlink_factura_lineas: Mapped[list['StarlinkFacturaLineas']] = relationship('StarlinkFacturaLineas', back_populates='factura_detalle')
...
class TelemetriaRouterResumenHora(Base):
    ...
    linea_servicio: Mapped[Optional['LineasServicio']] = relationship('LineasServicio', back_populates='telemetria_router_resumen_hora')
    router: Mapped['Routers'] = relationship('Routers', back_populates='telemetria_router_resumen_hora')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='telemetria_router_resumen_hora')
...
class TelemetriaTerminalResumenHora(Base):
    ...
    dispositivo: Mapped['Dispositivos'] = relationship('Dispositivos', back_populates='telemetria_terminal_resumen_hora')
    linea_servicio: Mapped['LineasServicio'] = relationship('LineasServicio', back_populates='telemetria_terminal_resumen_hora')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='telemetria_terminal_resumen_hora')
...
class ControlServicioHistorial(Base):
    ...
    comando_remoto: Mapped[Optional['ComandosRemotosLog']] = relationship('ComandosRemotosLog', back_populates='control_servicio_historial')
    linea_servicio: Mapped['LineasServicio'] = relationship('LineasServicio', back_populates='control_servicio_historial')
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', back_populates='control_servicio_historial')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='control_servicio_historial')


class GeozonaEventos(Base):
    ...
    usuarios: Mapped[Optional['Usuarios']] = relationship('Usuarios', back_populates='geozona_eventos')
    colaborador: Mapped[Optional['Colaboradores']] = relationship('Colaboradores', back_populates='geozona_eventos')
    comando_remoto: Mapped[Optional['ComandosRemotosLog']] = relationship('ComandosRemotosLog', back_populates='geozona_eventos')
    dispositivo: Mapped['Dispositivos'] = relationship('Dispositivos', back_populates='geozona_eventos')
    geozona: Mapped['Geozonas'] = relationship('Geozonas', back_populates='geozona_eventos')
    linea_servicio: Mapped[Optional['LineasServicio']] = relationship('LineasServicio', back_populates='geozona_eventos')
    politica: Mapped['GeozonaPoliticas'] = relationship('GeozonaPoliticas', back_populates='geozona_eventos')
    tenant: Mapped['Tenants'] = relationship('Tenants', back_populates='geozona_eventos')


class StarlinkFacturaLineas(Base):
    ...
    factura_detalle: Mapped['StarlinkFacturaDetalles'] = relationship('StarlinkFacturaDetalles', back_populates='starlink_factura_lineas')
    linea_servicio: Mapped['LineasServicio'] = relationship('LineasServicio', back_populates='starlink_factura_lineas')
