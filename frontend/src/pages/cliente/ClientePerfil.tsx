...
const ClientePerfil: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl py-4 sm:py-6 px-2 sm:px-4">
      <AlertPopup 
      ...
      <div className="bg-client-bg-surface rounded-[12px] shadow-sm border border-client-border overflow-hidden relative">
        ...
        <button 
          ...
          className="absolute top-4 right-4 p-2 text-client-text-secondary hover:bg-client-bg-subtle rounded-lg transition-colors z-10 cursor-pointer"
