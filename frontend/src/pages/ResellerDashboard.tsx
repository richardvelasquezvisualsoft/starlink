                ...
                <div className="flex-1 min-h-0">
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={chartData}>
                      ...
                      <XAxis dataKey="timestamp" stroke={axisColor} tick={{ fill: tickColor, fontSize: 10, fontWeight: 'bold' }} tickFormatter={(val: string) => formatTimeLabel(val, rangoTiempo)} interval={0} />
                      <YAxis stroke={axisColor} tick={{ fill: tickColor, fontSize: 10 }} width={35} />
                      <Tooltip 
          ...
          <div className="flex-1 min-h-[220px]">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={portfolioTrend}>
                ...
                <CartesianGrid strokeDasharray="3 3" stroke={gridColor} vertical={false} />
                <XAxis dataKey="periodo" stroke={axisColor} tick={{ fill: tickColor, fontWeight: 'bold', fontSize: 11 }} fontSize={11} tickMargin={10} tickFormatter={formatPeriodLabel} interval={0} />
          ...
          <div className="h-[220px]">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={qualityTrend}>
                <CartesianGrid strokeDasharray="3 3" stroke={gridColor} vertical={false} />
                <XAxis dataKey="periodo" stroke={axisColor} tick={{ fill: tickColor, fontWeight: 'bold', fontSize: 11 }} fontSize={11} tickMargin={10} tickFormatter={formatPeriodLabel} interval={0} />
                <YAxis domain={[(dataMin: number) => Math.max(0, Math.floor(dataMin - 5)), 100]} stroke={axisColor} tick={{ fill: tickColor, fontWeight: 'bold', fontSize: 11 }} fontSize={11} />
                <Tooltip 
                  contentStyle={{ backgroundColor: isLight ? '#ffffff' : '#111', borderColor: isLight ? '#cbd5e1' : '#333', borderRadius: '8px', color: isLight ? '#000000' : '#ffffff' }}
                  itemStyle={{ color: isLight ? '#000000' : '#fff' }}
                  labelFormatter={(label) => {
